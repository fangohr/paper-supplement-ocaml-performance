...
let create_tensors n d =
  Bigarray.Genarray.create Bigarray.float64 Bigarray.c_layout [|n; d; d; d|]
;;

(* Initialise a tensor. *)
let init_tensors tensors =
  let n = Bigarray.Genarray.nth_dim tensors 0 in
  let d = Bigarray.Genarray.nth_dim tensors 1 in
